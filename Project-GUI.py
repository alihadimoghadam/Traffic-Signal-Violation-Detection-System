...
class Window(Frame):
    ...
    def open_file(self):
        ...
        ret, image = cap.read()
        cv2.imwrite('D:/Traffic Violation Detection/Traffic Signal Violation Detection System/Images/preview.jpg', image)

        self.show_image('D:/Traffic Violation Detection/Traffic Signal Violation Detection System/Images/preview.jpg')
    ...
    def imgClick(self, event):
        ...
        if self.counter == 2:
            ...
            print(self.line)
            print(self.rect)
            img = cv2.imread('D:/Traffic Violation Detection/Traffic Signal Violation Detection System/Images/preview.jpg')
            cv2.line(img, self.line[0], self.line[1], (0, 255, 0), 3)
            cv2.imwrite('D:/Traffic Violation Detection/Traffic Signal Violation Detection System/Images/copy.jpg', img)
            self.show_image('D:/Traffic Violation Detection/Traffic Signal Violation Detection System/Images/copy.jpg')
    ...
    def main_process(self):
        ...
        fps = reader.get_meta_data()['fps']    
        writer = imageio.get_writer('D:/Traffic Violation Detection/Traffic Signal Violation Detection System/Resources/output/output.mp4', fps = fps)
